...
type PreviewIconScreenProps = NativeStackScreenProps<
  RootStackParamList,
  'PreviewIcon'
>;
...
export default function PreviewIcon({
...
}: PreviewIconScreenProps): React.JSX.Element {
  ...
  // 颜色选项 - 映射到 Tailwind 类名
  const colorOptions = [
    { name: '黑色', value: '#333', className: 'bg-custom-black' },
    { name: '主题绿', value: '#21b97a', className: 'bg-custom-green' },
    { name: '蓝色', value: '#1890ff', className: 'bg-custom-blue' },
    { name: '红色', value: '#ff4d4f', className: 'bg-custom-red' },
    { name: '橙色', value: '#ff9800', className: 'bg-custom-orange' },
    { name: '灰色', value: '#999', className: 'bg-custom-gray' },
  ];
            ...
            {colorOptions.map(color => (
              ...
              >
                <View className="flex-row items-center gap-2">
                  <View className={`w-4 h-4 rounded ${color.className}`} />
